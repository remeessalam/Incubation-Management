...
export default function Applicationlist() {
    ...
    return (
        <section>
            <Typography variant='h4' sx={{ color: 'black', marginBottom: '5px' }}> New Application List</Typography>
            <TableContainer component={Paper}>
                <Table sx={{ minWidth: 650 }} aria-label="simple table">
                    ...
                    <TableBody>
                        {newList==''? <p>NO NEW LIST</p>:newList.map((row, index) => (
                            <TableRow
                                key={row.name}
            ...
            <Typography variant='h4' sx={{ color: 'black', marginBottom: '5px', marginTop: '10px' }}> New Pending List</Typography>
            <TableContainer component={Paper}>
                <Table sx={{ minWidth: 650 }} aria-label="simple table">
                    <TableHead>
                        <TableRow>
                    ...
                    <TableBody>
                        ...
                        {pending==''? <p>NO PENDING LIST</p>:pending.map((row, index) => (
                            <TableRow
                                key={row.name}
                                sx={{ '&:last-child td, &:last-child th': { border: 0 } }}
                            >
