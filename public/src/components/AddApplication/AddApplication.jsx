        ...
        <section>
            ...
            <form id='forms' onSubmit={handleSubmit(onSubmit)}
                ...
                <div className='typeInc'>
                    ...
                    />
                    <label for='physical' style={{ color: 'black', marginLeft: '10px' }}>Physical Incubation</label><br></br>
                    <input type='radio' id='vertual' name='incubation' value='vertual'
                        {...register('type', {
                            required: { value: true, message: "This field is required" }
                        })}
                    />
                    <label for='virtual' style={{ color: 'black', marginLeft: '10px' }}>Virtual Incubation</label>
